...
export default function UpdateShipment() {
  ...
  async function handleSubmit(event) {
    ...
    const formData = {
      ...
      shipmentDate: event.target.shipmentdate.value,
    }

    try {
        const response = await axios.post('http://localhost:4000/updateShipmentDate', formData);
        console.log(response);
        swal("Success!", "Delivery Shipment date Updated Successfully!", "success");
    } catch (error) {
