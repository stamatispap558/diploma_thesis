...
createCertificateForRegulator(){
    echo
    echo "enrolling regulator Admin"
    echo
    mkdir -p ../crypto-config/peerOrganizations/regulator.exim.com/
    export FABRIC_CA_CLIENT_HOME=${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/


    fabric-ca-client enroll -u https://admin:adminpw@localhost:11054 --caname ca-regulator --tls.certfiles ${PWD}/fabric-ca/peerOrganizations/regulator.exim.com/tls-cert.pem

    echo 'NodeOUs:
    Enable: true
    ClientOUIdentifier:
        Certificate: cacerts/localhost-11054-ca-regulator.pem
        OrganizationalUnitIdentifier: client
    PeerOUIdentifier:
        Certificate: cacerts/localhost-11054-ca-regulator.pem
        OrganizationalUnitIdentifier: peer
    ...
    OrdererOUIdentifier:
        Certificate: cacerts/localhost-11054-ca-regulator.pem
        OrganizationalUnitIdentifier: orderer' >${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/msp/config.yaml

    echo
    echo "Register peer0"
    echo
    fabric-ca-client register --caname ca-regulator --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles ${PWD}/fabric-ca/peerOrganizations/regulator.exim.com/tls-cert.pem

    echo
    echo "Register peer1"
    echo
    fabric-ca-client register --caname ca-regulator --id.name peer1 --id.secret peer1pw --id.type peer --tls.certfiles ${PWD}/fabric-ca/peerOrganizations/regulator.exim.com/tls-cert.pem

    mkdir -p ../crypto-config/peerOrganizations/regulator.exim.com/peers

    echo
    echo "Register the org admin"
    echo

    fabric-ca-client register --caname ca-regulator --id.name regulator --id.secret regulatorpw --id.type admin --tls.certfiles ${PWD}/fabric-ca/peerOrganizations/regulator.exim.com/tls-cert.pem


    # -----------------------------------------------------------------------------------
    #  Peer 0
    mkdir -p ../crypto-config/peerOrganizations/regulator.exim.com/peers/peer0.regulator.exim.com

    echo
    echo "## Generate the peer0 msp"
    echo
    fabric-ca-client enroll -u https://peer0:peer0pw@localhost:11054 --caname ca-regulator -M ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/peers/peer0.regulator.exim.com/msp --csr.hosts peer0.regulator.exim.com --tls.certfiles ${PWD}/fabric-ca/peerOrganizations/regulator.exim.com/tls-cert.pem

    cp ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/msp/config.yaml ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/peers/peer0.regulator.exim.com/msp/config.yaml

    echo
    echo "## Generate the peer0-tls certificates"
    echo
    fabric-ca-client enroll -u https://peer0:peer0pw@localhost:11054 --caname ca-regulator -M ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/peers/peer0.regulator.exim.com/tls --enrollment.profile tls --csr.hosts peer0.regulator.exim.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/peerOrganizations/regulator.exim.com/tls-cert.pem

    cp ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/peers/peer0.regulator.exim.com/tls/tlscacerts/* ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/peers/peer0.regulator.exim.com/tls/ca.crt
    cp ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/peers/peer0.regulator.exim.com/tls/signcerts/* ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/peers/peer0.regulator.exim.com/tls/server.crt
    cp ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/peers/peer0.regulator.exim.com/tls/keystore/* ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/peers/peer0.regulator.exim.com/tls/server.key

    mkdir ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/msp/tlscacerts
    cp ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/peers/peer0.regulator.exim.com/tls/tlscacerts/* ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/msp/tlscacerts/ca.crt

    mkdir ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/tlsca
    cp ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/peers/peer0.regulator.exim.com/tls/tlscacerts/* ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/tlsca/tlsca-regulator-cert.pem

    mkdir ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/ca
    cp ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/peers/peer0.regulator.exim.com/msp/cacerts/* ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/ca/ca-regulator-cert.pem

    # ------------------------------------------------------------------------------------------------

    # Peer1

    mkdir -p ../crypto-config/peerOrganizations/regulator.exim.com/peers/peer1.regulator.exim.com

    echo
    echo "## Generate the peer1 msp"
    echo
    fabric-ca-client enroll -u https://peer1:peer1pw@localhost:11054 --caname ca-regulator -M ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/peers/peer1.regulator.exim.com/msp --csr.hosts peer1.regulator.exim.com --tls.certfiles ${PWD}/fabric-ca/peerOrganizations/regulator.exim.com/tls-cert.pem

    cp ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/msp/config.yaml ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/peers/peer1.regulator.exim.com/msp/config.yaml

    echo
    echo "## Generate the peer1-tls certificates"
    echo
    fabric-ca-client enroll -u https://peer1:peer1pw@localhost:11054 --caname ca-regulator -M ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/peers/peer1.regulator.exim.com/tls --enrollment.profile tls --csr.hosts peer1.regulator.exim.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/peerOrganizations/regulator.exim.com/tls-cert.pem

    cp ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/peers/peer1.regulator.exim.com/tls/tlscacerts/* ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/peers/peer1.regulator.exim.com/tls/ca.crt
    cp ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/peers/peer1.regulator.exim.com/tls/signcerts/* ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/peers/peer1.regulator.exim.com/tls/server.crt
    cp ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/peers/peer1.regulator.exim.com/tls/keystore/* ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/peers/peer1.regulator.exim.com/tls/server.key

    # # --------------------------------------------------------------------------------------------------

    mkdir -p ../crypto-config/peerOrganizations/regulator.exim.com/users

    mkdir -p ../crypto-config/peerOrganizations/regulator.exim.com/users/Admin@regulator.exim.com

    echo
    echo "## Generate the org admin msp"
    echo
    fabric-ca-client enroll -u https://regulator:regulatorpw@localhost:11054 --caname ca-regulator -M ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/users/Admin@regulator.exim.com/msp --tls.certfiles ${PWD}/fabric-ca/peerOrganizations/regulator.exim.com/tls-cert.pem

    cp ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/msp/config.yaml ${PWD}/../crypto-config/peerOrganizations/regulator.exim.com/users/Admin@regulator.exim.com/msp/config.yaml
}
